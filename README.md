...
The original Terrain style only covered the United States. As part of a Knight Foundation grant, we are expanding Terrain to cover the entire world. The Knight Grant may also suppoert some totally-different new terrain styles, so to avoid confusion, we are calling the old style "Terrain Classic."
